...
export function Timer (callback, delay) {
  console.log('Timer', callback, delay);
  ...
  this.resume = function() {
    start = Date.now();
    clearTimeout(this.timeoutId);  // when object.timer undefined, it passes.
    this.timeoutId = setTimeout(callback, remaining);  // set one proptype to record timeoutID
  };
